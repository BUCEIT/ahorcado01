...
namespace ahorcado01
{
    public partial class Form1 : Form
    {
        ...
        private void botoPulsado(object sender, EventArgs e)
        {
            ...
            {
                //Console.WriteLine(letra); //sistema println basico
                int posicion = palabraOculta.IndexOf(letra);
                label1.Text = label1.Text.Remove(2 * posicion, 1).Insert(2 * posicion, letra); //elimina los guiones por las letras de la palabra
